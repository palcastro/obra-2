    ...
    <nav class="navbar navbar-light my-4">
      <div class="container-fluid">
        ...
        <form class="d-flex" action="./busqueda.php" method="POST">
          <!-- Botón añadir nuevo -->
          <div class="mr-4"> <a href="functions/nuevo.php" class="btn btn-white mb-3" alt="Engadir nova empres">
          ...
          <?php while ($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
            <tr>
              ...
              <td class="d-flex"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye " viewBox="0 0 16 16">
                ...
                <a href="functions/modificar.php?id=<?php echo $row['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" alt="Modificar rexistro" width="16" height="16" fill="currentColor" class="bi bi-pencil mx-2" viewBox="0 0 16 16">
